...
export default {
    ...
    actions: {
         Favor: async function ({commit},[id,make,model,year,url]){
             commit('favoritCar',[id,make,model,year,url])
         },


        Token: async function ({commit},[url, email, pass]) {
            ...
            }).then(commit('setToken', localStorage.getItem('token'))
            ).catch(err=>console.log(err))


        },
        editCar:function ({commit},[make,model,year,url]) {
            commit('editCar',[make,model,year,url])
        }
    }
        ...
        mutations: {
            ...
            editCar(state,[make,model,year,url]){
                state.inventory.car_make = make
                state.inventory.car_model = model
                state.inventory.car_year = year
                state.inventory.car_url = url
            },
            favoritCar(state,[{id:id,car_make:car_make,car_model:car_model,car_year:car_year,url:url}]){

                    state.faforitsCars = id
                    state.faforitsCars = car_make
                    state.faforitsCars = car_model
                    state.faforitsCars = car_year
                    state.faforitsCars = url
        ...
        getters: {
            ...
            getFavoritCar:state =>state.faforitsCars
        }
